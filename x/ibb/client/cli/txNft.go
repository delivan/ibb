...
func CmdCreateMockNft() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msgDogeCollection2 := types.NewMsgCreateNft(clientCtx.GetFromAddress().String(), "Dodge to the Moon Collection", clientCtx.GetFromAddress().String(), "https://i.pinimg.com/736x/4d/9c/82/4d9c826f50fd5c6916d1a28877c574a6.jpg", "Dogetronaut", "cosmosxylt3vm62x7z1dd74sdealtvyr7rmm9rpzpsjy0", argsSelectedOffer, argsOffers)
